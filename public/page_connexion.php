...
<head>
    ...
    <title>Se connecter | CheckMaster</title>
</head>
        ...
        <div class="grid md:grid-cols-2 items-center gap-6 max-w-6xl w-full">
            <div
                ...
                <form action="login.php" method="POST" class="space-y-6">
                    ...
                    <div class="mb-12">
                        <div>
                            <a href="#"><img src="./images/logo_cm_sbg.png" class="mx-auto block"
                                             style="width:20%" /></a>
                            <h3 class="text-primary-500 text-3xl font-semibold">Se connecter</h3>
                        </div>
                    ...
                    <div>
                        <label class="text-primary-500 text-sm font-medium mb-2 block">Login</label>
                    ...
                    <div>
                        <label class="text-primary-500 text-sm font-medium mb-2 block">Mot de passe</label>
                        <div class="relative flex items-center">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <div class="text-sm">
                            <a href="reset_password.php"
                               class="text-primary-500 underline hover:underline font-medium">
                                Mot de passe oublié?
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="!mt-12">
                        ...
                        <button type="submit"
                                class="w-full shadow-xl py-2.5 px-4 text-[15px] font-medium tracking-wide rounded-lg text-white bg-primary-500 hover:bg-primary-700 focus:outline-none">
                            Se connecter
                        </button>
                    </div>
                </form>
