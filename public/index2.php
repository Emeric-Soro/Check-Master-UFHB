...
<body class="font-sans antialiased text-gray-800" style="background-color: #DFF2FF;">
    <!-- Navigation -->
        ...
        <div class="container mx-auto flex flex-col lg:flex-row items-center">
            ...
            <div class="lg:w-1/2 flex justify-center">
                <div class="relative w-full max-w-xl">
                    ...
                    <div class="absolute -bottom-6 -left-6 w-32 h-32 rounded-full bg-primary-100 opacity-50 -z-10">
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md feature-card transition duration-300">
                    ...
                    <ul class="space-y-2 text-gray-600">
                        ...
                        <li class="flex items-center"><i class="fas fa-check-circle text-primary-500 mr-2"></i> Suivi
                            des
                            dossiers</li>
                    </ul>
                </div>
