    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-primary/95 backdrop-blur-sm transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center  space-x-8">
                    ...
                    <a href="#features"
                        class="text-white hover:text-primary-lighter transition-colors font-medium">Fonctionnalités</a>
                    <a href="#services"
                        class="text-white hover:text-primary-lighter transition-colors font-medium">Services</a>
                    <a href="index.php"
                        class="text-white hover:text-primary-lighter transition-colors font-medium">UFHB</a>
        ...
        <div class="md:hidden bg-primary/95 backdrop-blur-sm border-t border-white/20 hidden" id="mobile-menu">
            <div class="px-4 py-4 space-y-4">
                ...
                <a href="#features"
                    class="block text-white hover:text-primary-lighter transition-colors font-medium">Fonctionnalités</a>
                <a href="#services"
                    class="block text-white hover:text-primary-lighter transition-colors font-medium">Services</a>
                <a href="index.php"
                    class="block text-white hover:text-primary-lighter transition-colors font-medium">UFHB</a>
                <a href="page_connexion.php"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-gray-50 rounded-2xl p-8 mb-8">
                        ...
                        <p class="text-lg text-gray-600 leading-relaxed mb-6">
                            Une plateforme innovante dédiée à la gestion des commissions de validation de soutenance
                            pour les étudiants en Master 2 MIAGE à l'UFHB. Elle facilite l'évaluation des étudiants, le
                            dépôt des documents, et le suivi du processus.
                        </p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                            ...
                            <div class="flex items-center">
                                <div
                                    class="w-8 h-8 bg-primary-light/10 rounded-lg flex items-center justify-center mr-3">
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-gradient-to-br from-primary/5 to-primary-light/5 rounded-2xl p-8 text-center">
                        <div
                            class="w-48 h-48 mx-auto mb-6 bg-white rounded-xl shadow-lg flex items-center justify-center">
                            <img src="image/logo_cm_sbg.png" alt="CheckMaster Logo" class="w-32 h-32 object-contain">
                        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16 animate-fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Découvrez les fonctionnalités puissantes qui rendent CheckMaster indispensable pour la gestion de
                    vos soutenances
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Espace Personnalisé -->
                <div
                    class="feature-card bg-white rounded-2xl shadow-lg p-8 text-center border border-gray-100 animate-slide-up">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-primary to-primary-light rounded-2xl flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition-transform duration-300">
                        <i class="fas fa-users text-3xl text-white"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Espace Personnalisé</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Chaque utilisateur dispose d'un espace dédié pour accomplir ses tâches spécifiques avec une
                        interface intuitive et adaptée à son rôle.
                    </p>
                </div>
                ...
                <div class="feature-card bg-white rounded-2xl shadow-lg p-8 text-center border border-gray-100 animate-slide-up"
                    ...
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-accent to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-folder text-3xl text-white"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Gestion Documentaire</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Archivage sécurisé et centralisé de tous les documents liés aux soutenances, facilitant la
                        recherche et la consultation des documents importants.
                    </p>
                </div>
                ...
                <div class="feature-card bg-white rounded-2xl shadow-lg p-8 text-center border border-gray-100 animate-slide-up"
                    ...
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-secondary to-yellow-600 rounded-2xl flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition-transform duration-300">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Visualisation claire de l'avancement du processus de soutenance avec notifications automatiques
                        à chaque étape validée par les différents acteurs.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="service-card bg-white rounded-2xl shadow-lg overflow-hidden animate-slide-up">
                    <div class="grid grid-cols-1 lg:grid-cols-2">
                        <div class="relative h-64 lg:h-auto">
                            <img src="image/etudiants_img.jpg" alt="Espace étudiant" class="w-full h-full object-cover">
                        ...
                        <div class="p-8 lg:p-12 flex flex-col justify-center">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-6">
                                Accédez à votre espace personnel dédié pour soumettre votre mémoire, consulter la
                                composition détaillée de votre jury et recevoir tous les retours et évaluations
                                nécessaires à votre préparation.
                            </p>
                            <a href="page_connexion.php"
                                class="inline-flex items-center text-primary hover:text-primary-light font-semibold transition-colors group">
                ...
                <div class="service-card bg-white rounded-2xl shadow-lg overflow-hidden animate-slide-up"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2">
                        <div class="order-2 lg:order-1 p-8 lg:p-12 flex flex-col justify-center">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-6">
                                Gérez efficacement votre travail, accédez aux rapports et mémoires complets des
                                étudiants et saisissez vos notes et commentaires dans un environnement de travail
                                optimisé.
                            </p>
                            <a href="page_connexion.php"
                                class="inline-flex items-center text-accent hover:text-primary-600 font-semibold transition-colors group">
                                Accéder à mon espace
                                <i
                                    class="fas fa-arrow-right ml-2 transform group-hover:translate-x-2 transition-transform"></i>
                            </a>
                ...
                <div class="service-card bg-white rounded-2xl shadow-lg overflow-hidden animate-slide-up"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div class="p-8 lg:p-12 flex flex-col justify-center">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-6">
                                Évaluez les rapports des étudiants, consultez les comptes rendus de commission et
                                supervisez l'ensemble du processus via un tableau de bord complet et intuitif.
                            </p>
                            <a href="page_connexion.php"
                                class="inline-flex items-center text-secondary hover:text-yellow-600 font-semibold transition-colors group">
                                Accéder à mon espace
                                <i
                                    class="fas fa-arrow-right ml-2 transform group-hover:translate-x-2 transition-transform"></i>
                            </a>
        ...
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <div class="animate-fade-in">
                ...
                <p class="text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Rejoignez la plateforme CheckMaster et simplifiez la gestion de vos soutenances MIAGE dès
                    aujourd'hui.
                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-gray-400 mb-6 max-w-md">
                        Plateforme innovante dédiée à la gestion des commissions de validation de soutenance pour les
                        étudiants en Master 2 MIAGE à l'UFHB.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="page_connexion.php"
                                class="text-gray-400 hover:text-white transition-colors">Connexion</a></li>
                    </ul>
                </div>
