...
<head>
            ...
            theme: {
                extend: {
                    ...
                    backgroundImage: {
                        ...
                        'card-gradient': 'linear-gradient(135deg, #DFF2FF 0%, #C8E8FF 100%)',
                    },
                    fontFamily: {
    ...
    <style>
        ...
        /* Override background colors to #DFF2FF */
        body,
        .bg-gray-50,
        .bg-white {
...
<body class="font-poppins bg-gray-50">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-3">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-primary to-primary-light rounded-xl flex items-center justify-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#accueil"
                        class="text-white hover:text-primary-lighter transition-colors font-medium">Accueil</a>
                    <a href="#about" class="text-white hover:text-primary-lighter transition-colors font-medium">À
                        propos</a>
                    <a href="#formations"
                        class="text-white hover:text-primary-lighter transition-colors font-medium">Formations</a>
                    <a href="public/indexCM.php"
                        class="text-white hover:text-primary-lighter transition-colors font-medium">Plateforme</a>
                    <a href="public/page_connexion.php"
                        class="bg-primary-light text-white px-6 py-2 rounded-lg hover:bg-primary-lighter transition-colors font-medium">
        ...
        <div class="md:hidden bg-primary/95 backdrop-blur-sm border-t border-white/20 hidden" id="mobile-menu">
            <div class="px-4 py-4 space-y-4">
                <a href="#accueil"
                    class="block text-white hover:text-primary-lighter transition-colors font-medium">Accueil</a>
                <a href="#about" class="block text-white hover:text-primary-lighter transition-colors font-medium">À
                    propos</a>
                <a href="#formations"
                    class="block text-white hover:text-primary-lighter transition-colors font-medium">Formations</a>
                <a href="#platform"
                    class="block text-white hover:text-primary-lighter transition-colors font-medium">Plateforme</a>
                <a href="public/page_connexion.php"
                    class="block bg-primary-light text-white px-4 py-2 rounded-lg hover:bg-primary-lighter transition-colors font-medium text-center">
                    <i class="fas fa-sign-in-alt mr-2"></i>Connexion
                </a>
            </div>
        </div>
    ...
    <section id="accueil" class="relative h-screen hero-slider">
        ...
        <div class="slide active">
            <img src="public/image/ufhb3.jpg" alt="Université Félix Houphouët-Boigny">
            <div class="absolute inset-0 bg-hero-gradient"></div>
        </div>
        <div class="slide">
            <img src="public/image/ufhb2.jpeg" alt="Formations universitaires">
            <div class="absolute inset-0 bg-hero-gradient"></div>
        </div>
        <div class="slide">
            <img src="public/image/ufhb4.jpg" alt="Recherche universitaire">
            <div class="absolute inset-0 bg-hero-gradient"></div>
        </div>
        ...
        <button
            class="absolute left-8 top-1/2 transform -translate-y-1/2 bg-white/20 backdrop-blur-sm text-white p-3 rounded-full hover:bg-white/30 transition-colors"
            id="prev-slide">
            <i class="fas fa-chevron-left"></i>
        </button>
        <button
            class="absolute right-8 top-1/2 transform -translate-y-1/2 bg-white/20 backdrop-blur-sm text-white p-3 rounded-full hover:bg-white/30 transition-colors"
            id="next-slide">
            ...
            <div class="space-y-20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="animate-slide-in-left">
                        <div class="relative">
                            <img src="public/image/about_img1.jpg" alt="Histoire de l'université"
                                class="rounded-2xl shadow-2xl w-full h-80 object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-primary/30 to-transparent rounded-2xl">
                            </div>
                        </div>
                    </div>
                    <div class="animate-slide-in-right">
                        <div class="bg-card-gradient p-8 rounded-2xl shadow-lg">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Fondée en 1964, l'Université Félix Houphouët-Boigny (anciennement Université de Cocody)
                                porte le nom du père fondateur de la nation ivoirienne. Avec plus de cinq décennies
                                d'excellence académique, notre institution a formé des générations de leaders et
                                contribué significativement au développement du pays.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="order-2 lg:order-1 animate-slide-in-left">
                        <div class="bg-card-gradient p-8 rounded-2xl shadow-lg">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Situé au cœur de Cocody, notre campus s'étend sur plusieurs hectares et offre un
                                environnement propice aux études et à la recherche. Nos infrastructures modernes
                                comprennent des amphithéâtres, des laboratoires équipés, une bibliothèque universitaire
                                riche de milliers d'ouvrages et des espaces de vie communautaire.
                            </p>
                        </div>
                    </div>
                    <div class="order-1 lg:order-2 animate-slide-in-right">
                        <div class="relative">
                            <img src="public/image/about_img2.png" alt="Campus universitaire"
                                class="rounded-2xl shadow-2xl w-full h-80 object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-accent/30 to-transparent rounded-2xl">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="animate-slide-in-left">
                        <div class="relative">
                            <img src="public/image/about_img3.jpg" alt="Corps professoral"
                                class="rounded-2xl shadow-2xl w-full h-80 object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-secondary/30 to-transparent rounded-2xl">
                            </div>
                        </div>
                    </div>
                    <div class="animate-slide-in-right">
                        <div class="bg-card-gradient p-8 rounded-2xl shadow-lg">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                L'UFHB s'enorgueillit de compter parmi son personnel enseignant des professeurs de
                                renommée internationale, des chercheurs passionnés et des experts dans leurs domaines
                                respectifs. Notre équipe pédagogique s'engage à offrir un enseignement de qualité et à
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="order-2 lg:order-1 animate-slide-in-left">
                        <div class="bg-card-gradient p-8 rounded-2xl shadow-lg">
                            <div class="flex items-center mb-4">
                                <div
                                    class="w-12 h-12 bg-primary-light/10 rounded-lg flex items-center justify-center mr-4">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                ...
                                nombreuses universités et institutions de recherche à travers le monde. Ces
                                collaborations favorisent la mobilité des étudiants et des enseignants, les projets de
                                recherche conjoints et l'échange de bonnes pratiques académiques.
                            </p>
                        </div>
                    </div>
                    <div class="order-1 lg:order-2 animate-slide-in-right">
                        <div class="relative">
                            <img src="public/image/about_img4.jpg" alt="Coopération internationale"
                                class="rounded-2xl shadow-2xl w-full h-80 object-cover">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-primary-light/30 to-transparent rounded-2xl">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="formations" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Sciences -->
                <div
                    class="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl animate-slide-up">
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">Mathématiques, Physique, Chimie, Biologie et Sciences de la Terre.
                        </p>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl animate-slide-up"
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">Langues, Littérature, Histoire, Géographie, Philosophie,
                            Sociologie.</p>
                        <ul class="space-y-2 text-sm text-gray-600">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl animate-slide-up"
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">Droit privé, Droit public, Sciences politiques, Relations
                            internationales.</p>
                        <ul class="space-y-2 text-sm text-gray-600">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-xl animate-slide-up"
                    ...
                    <div class="p-6">
                        <p class="text-gray-600 mb-4">Médecine générale, Pharmacie, Odontologie, Sciences infirmières.
                        </p>
                        <ul class="space-y-2 text-sm text-gray-600">
    ...
    <section id="platform" class="py-20 bg-gradient-to-r from-primary to-primary-light">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center animate-fade-in">
                <div class="mb-8">
                    <div
                        class="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-6 animate-float">
                    ...
                    <p class="text-xl text-white/90 max-w-4xl mx-auto mb-8 leading-relaxed">
                        La filière MIAGE (Méthodes Informatiques Appliquées à la Gestion des Entreprises) de l'UFHB
                        dispose d'une plateforme moderne et innovante dédiée à la gestion de la commission de validation
                        des étudiants en Master 2.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div class="glass-effect rounded-2xl p-6 transform transition-all duration-300 hover:scale-105">
                        ...
                        <p class="text-gray-600">Processus de validation numérique des rapports de stage et mémoires en
                            temps réel.</p>
                    </div>
                    ...
                    <div class="glass-effect rounded-2xl p-6 transform transition-all duration-300 hover:scale-105"
                        ...
                        <p class="text-gray-600">Interface collaborative pour les enseignants, étudiants et personnel
                            administratif.</p>
                    </div>
                    ...
                    <div class="glass-effect rounded-2xl p-6 transform transition-all duration-300 hover:scale-105"
                        ...
                        <p class="text-gray-600">Tableaux de bord analytiques et statistiques en temps réel pour le
                            suivi des validations.</p>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-gray-400 mb-6 max-w-md">
                        Plus de 50 ans d'excellence académique au service de l'éducation supérieure en Côte d'Ivoire et
                        en Afrique.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#formations"
                                class="text-gray-400 hover:text-white transition-colors">Formations</a></li>
                        <li><a href="#platform" class="text-gray-400 hover:text-white transition-colors">Plateforme</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <a href="#" class="text-gray-400 hover:text-white text-sm transition-colors">Conditions
                        d'utilisation</a>
                    <a href="#" class="text-gray-400 hover:text-white text-sm transition-colors">Politique de
                        confidentialité</a>
                </div>
            </div>
        </div>
    ...
    <button
        class="fixed bottom-8 right-8 w-12 h-12 bg-primary text-white rounded-full shadow-lg hover:bg-primary-light transition-all duration-300 transform hover:scale-110 z-50 hidden"
        id="back-to-top">
