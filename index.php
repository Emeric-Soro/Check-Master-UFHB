...
<nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300" id="navbar">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="public/indexCM.php" class="text-white hover:text-primary-lighter transition-colors font-medium">Plateforme</a>
                <a href="public/page_connexion.php" class="bg-primary-light text-white px-6 py-2 rounded-lg hover:bg-primary-lighter transition-colors font-medium">
    ...
    <div class="md:hidden bg-primary/95 backdrop-blur-sm border-t border-white/20 hidden" id="mobile-menu">
        <div class="px-4 py-4 space-y-4">
            ...
            <a href="public/page_connexion.php" class="block bg-primary-light text-white px-4 py-2 rounded-lg hover:bg-primary-lighter transition-colors font-medium text-center">
                <i class="fas fa-sign-in-alt mr-2"></i>Connexion
            </a>
        </div>
    </div>
