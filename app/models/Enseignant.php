...
class Enseignant
{
    ...
    public function getAllEnseignants()
    {
        try {
            ...
            $this->logger->error("Erreur lors de la récupération de tous les enseignants : " . $e->getMessage());
            return [];
        }
    }
    ...
    public function getEnseignantByLogin($login)
    {
        try {
            ...
            $this->logger->error("Erreur lors de la récupération de l'enseignant par login : " . $e->getMessage());
            return null;
        }
    }
    ...
    public function ajouterEnseignant($nom, $prenom, $email, $id_grade, $id_specialite, $id_fonction, $date_grade, $date_fonction, $type_enseignant)
    {
        try {
            ...
            $this->pdo->rollBack();
            $this->logger->error("Erreur lors de l'ajout de l'enseignant: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function modifierEnseignant($id, $nom, $prenom, $email, $id_grade, $id_specialite, $id_fonction, $date_grade, $date_fonction, $type_enseignant)
    {
        try {
            ...
            $this->pdo->rollBack();
            $this->logger->error("Erreur lors de la modification de l'enseignant: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function supprimerEnseignant($id)
    {
        try {
            ...
            $this->pdo->rollBack();
            $this->logger->error("Erreur lors de la suppression de l'enseignant: " . $e->getMessage());
            return false;
        }
    }
}