...
class Scolarite
{
    ...
    public function addVersement($data)
    {
        try {
            ...
            $sql = "INSERT INTO versements (id_inscription, montant, methode_paiement, date_versement, type_versement) 
                    VALUES (:id_inscription, :montant, :methode_paiement, :date_versement, 'Tranche')";
            ...
            $result = $stmt->execute([
                ...
                'date_versement' => $data['date_versement'] ?? date('Y-m-d H:i:s')
            ]);
    ...
    public function updateVersement($id_versement, $data)
    {
        try {
            ...
            $stmt->execute([
                ...
                $data['date_versement'] ?? date('Y-m-d H:i:s'),
                $id_versement
            ]);
