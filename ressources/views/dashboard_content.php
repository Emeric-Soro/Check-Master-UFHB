...
<head>
    ...
    <style>
        ...
        .gradient-red {
            background: linear-gradient(135deg, var(--green), #0b8b55) !important
        }
        ...
        .gradient-bg {
            background: linear-gradient(135deg, #DFF2FF 0%, #C8E8FF 100%)
        }
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 card-hover">
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <div class="flex space-x-2">
                                    <button id="prevMonth"
                                        class="w-8 h-8 rounded-md bg-blue-100 flex items-center justify-center text-blue-600 hover:bg-blue-200"><i
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 card-hover">
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <button class="text-blue-400 hover:text-blue-600"><i
                                    ...
                                    <?php foreach ($GLOBALS['activites_recentes'] as $activite): ?>
                                        <div class="flex items-start space-x-3">
                                            <div class="flex-shrink-0">
                                                <div
                                                    class="w-8 h-8 rounded-full <?php echo $activite['type'] === 'utilisateur' ? 'bg-blue-100' : 'bg-green-100'; ?> flex items-center justify-center">
                                                    <i
                                                        class="fas <?php echo $activite['type'] === 'utilisateur' ? 'fa-user' : 'fa-cog'; ?> text-sm <?php echo $activite['type'] === 'utilisateur' ? 'text-blue-600' : 'text-green-600'; ?>"></i>
                                                </div>
                                            </div>
