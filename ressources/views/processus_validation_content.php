...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Aperçu de tous les rapports approuvés par la chargée de communication et leurs évaluations par les
                membres de la commission</p>
        </div>

        <?php if ($message): ?>
            <div class="alert alert-<?= $message['success'] ? 'success' : 'danger' ?>"
                style="padding: 15px; margin-bottom: 20px; border-radius: 4px; <?= $message['success'] ? 'background-color: #d4edda; color: #155724; border: 1px solid #c3e6cb;' : 'background-color: #f8d7da; color: #721c24; border: 1px solid #f5c6cb;' ?>">
        ...
        <div class="stats">
            <div class="stat-card">
                ...
                <p style="font-size: 24px; font-weight: bold; color: #007bff;"><?= $statistiques['total_rapports'] ?>
                </p>
            </div>
            <div class="stat-card">
        ...
        <div class="filters">
            ...
            <div class="filter-grid">
                ...
                <div>
                    ...
                    <select id="memberFilter" onchange="filterReports()">
                        ...
                        <?php foreach ($membresCommission as $membre): ?>
                            <option
                                value="<?= htmlspecialchars($membre['nom_enseignant'] . ' ' . $membre['prenom_enseignant']) ?>">
                ...
                <div>
                    ...
                    <input type="text" id="searchFilter" placeholder="Rechercher un rapport..."
            ...
            <?php else: ?>
                <?php foreach ($rapports as $rapport): ?>
                    <div class="report-item" data-status="<?= $rapport['statut_vote']['statut'] ?>">
                        ...
                        <p><strong>Approuvé par:</strong>
                            <?= htmlspecialchars($rapport['nom_pers_admin'] . ' ' . $rapport['prenom_pers_admin']) ?></p>
                                ...
                                <?php foreach ($rapport['evaluations'] as $evaluation): ?>
                                    <div class="evaluation-item">
                                        <div class="evaluator">
                                            ...
                                            <span
                                                class="decision-<?= $evaluation['decision_evaluation'] === 'valider' ? 'valid' : 'reject' ?>"
                        ...
                        <div class="actions" style="margin-top: 15px;">
                            ...
                            <?php if ($rapport['statut_vote']['total_votes'] == 4 && !$rapport['statut_vote']['finalise']): ?>
                                <form id="form-finaliser-<?= $rapport['id_rapport'] ?>" method="POST" style="display:inline;">
                                    ...
                                    <input type="hidden" name="commentaire_validation"
                                        id="commentaire-<?= $rapport['id_rapport'] ?>" value="">
    ...
    <div id="confirmationModal"
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 transform transition-all duration-300 scale-95 opacity-0"
            ...
            <div class="p-6">
                <p class="text-gray-700 mb-4">Voulez-vous vraiment finaliser la décision finale concernant ce rapport ?
                </p>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="commentaireFinalisation" name="commentaire_validation" rows="3"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                        placeholder="Ajoutez un commentaire pour expliquer la décision finale..."></textarea>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-sm text-blue-700">
                            Cette action est irréversible. La décision sera automatiquement déterminée selon le nombre
                            de votes favorables.
                        </p>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
                ...
                <button type="button"
                    class="px-4 py-2 text-white bg-green-600 hover:bg-green-700 rounded-lg transition-colors duration-200 flex items-center"
                    id="confirmFinalisation">
