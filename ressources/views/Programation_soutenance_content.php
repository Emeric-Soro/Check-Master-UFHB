            ...
            <div class="cm-toolbar cm-prog-toolbar">
                <div class="cm-prog-toolbar__row">
                    ...
                    <select id="cmProgLimit" class="cm-form-control cm-form-select is-sm cm-toolbar-field-xs"
                        data-cm-ajax-param="limit_prog" data-cm-ajax-reset-param="page_prog"
                    ...
                    <button type="button" class="cm-btn is-info is-sm" id="cmProgSelectAllBtn">Tout sélectionner</button>
                    <button type="button" class="cm-btn is-light is-sm" id="cmProgDeselectBtn">Tout désélectionner</button>
                    <button type="button" class="cm-btn is-light is-sm" id="cmProgDeleteBtn" disabled>Supprimer (0)</button>
                    ...
                    <button type="button" class="cm-btn is-light is-sm" id="cmProgPrint">Imprimer</button>
                    <button type="button" class="cm-btn is-info is-sm" id="cmProgExport">Exporter</button>
