                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select id="type_message" name="type_message" required
                                ...
                                <option value="info" <?= $message_a_modifier && $message_a_modifier->type_message == 'info' ? 'selected' : '' ?>>
                                    Information</option>
                                <option value="success" <?= $message_a_modifier && $message_a_modifier->type_message == 'success' ? 'selected' : '' ?>>
                                    Succès</option>
                                <option value="warning" <?= $message_a_modifier && $message_a_modifier->type_message == 'warning' ? 'selected' : '' ?>>
                                    Avertissement</option>
                                <option value="error" <?= $message_a_modifier && $message_a_modifier->type_message == 'error' ? 'selected' : '' ?>>
                                    Erreur</option>
                            </select>
                        </div>
                    </div>
