...
cm_render_param_crud_view([
    ...
    'form_title_add' => 'Ajout specialite',
    'form_title_edit' => 'Modification specialite',
    'id_key' => 'id_specialite',
    'id_param' => 'id_specialite',
    'list' => is_array($GLOBALS['listeSpecialites'] ?? null) ? $GLOBALS['listeSpecialites'] : [],
    'edit' => $GLOBALS['specialite_a_modifier'] ?? null,
    ...
    'add_button_name' => 'btn_add_specialite',
    'edit_button_name' => 'btn_modifier_specialite',
