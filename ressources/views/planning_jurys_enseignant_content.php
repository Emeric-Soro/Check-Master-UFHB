...
$isAdmin = isAdmin() || (isset($_SESSION['id_GU']) && in_array((int) $_SESSION['id_GU'], [6, 8], true));
                            ...
                            <tbody>
                                <?php foreach ($monthGroup['items'] as $item): ?>
                                    <tr class="cm-data-table__row cm-clickable-row"
                                        ...
                                        <td class="cm-data-table__td">
                                            <?= htmlspecialchars($item['jour_semaine'], ENT_QUOTES, 'UTF-8') ?></td>
                                        <td class="cm-data-table__td">
                                            <?= htmlspecialchars($item['heure_soutenance'] ?? '--:--', ENT_QUOTES, 'UTF-8') ?></td>
                                        <td class="cm-data-table__td is-center">S<?= $item['week_number'] ?></td>
                                        <td class="cm-data-table__td">
                                            <?= htmlspecialchars($item['etudiant'], ENT_QUOTES, 'UTF-8') ?></td>
                                        <td class="cm-data-table__td"><?= htmlspecialchars($item['salle'], ENT_QUOTES, 'UTF-8') ?>
                                        </td>
                                        <td class="cm-data-table__td">
                                            <?php
