    ...
    <div class="cm-barre-intermediaire">
        <div class="cm-toolbar">
            ...
            <div class="cm-toolbar-center">
                <input type="text" id="cmSearchVersement" class="cm-form-control" placeholder="Rechercher (etudiant, numero, mode)...">
            </div>
            ...
            <table class="cm-data-table" id="cmVersementsTable">
                ...
                <tr>
                    <th class="cm-data-table__th is-checkbox">
                        <input type="checkbox" id="cmCheckAllVersements" class="cm-checkbox" aria-label="Selectionner toutes les lignes">
                    </th>
