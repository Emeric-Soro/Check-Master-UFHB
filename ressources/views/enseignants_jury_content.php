...
try {
    ...
    if ($anneeActive && is_object($anneeActive) && !empty($anneeActive->date_deb) && !empty($anneeActive->date_fin)) {
        ...
        if (($filtreAnneeAdmin === null || $filtreAnneeAdmin <= 0) && !$allYearsSelected) {
                        ...
                        <?php else: ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($ens['mail_enseignant'])): ?>
                                            <a href="mailto:<?= htmlspecialchars($ens['mail_enseignant'], ENT_QUOTES, 'UTF-8') ?>" class="cm-text-primary">
                                                <i class="fas fa-envelope cm-mr-xs"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (!empty($ens['tel_enseignant'])): ?>
                                            <span class="cm-text-muted cm-text-sm">
                                                <i class="fas fa-phone cm-mr-xs"></i><?= htmlspecialchars($ens['tel_enseignant'], ENT_QUOTES, 'UTF-8') ?>
                                            </span>
                                        <?php endif; ?>
                                    </td>
