...
<head>
    ...
    <style>
        ...
        .gradient-red {
            background: linear-gradient(135deg, var(--green), #0b8b55)
        }
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="p-4 rounded-lg gradient-blue text-white">
                                ...
                                <p class="text-2xl font-bold"><?php echo number_format($stats['reclamations_total']); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="p-4 rounded-lg gradient-blue text-white">
                                ...
                                <p class="text-2xl font-bold"><?php echo number_format($stats['paiements_complets']); ?>
                                </p>
                            </div>
                            <div class="p-4 rounded-lg gradient-red text-white">
                                <p class="text-sm font-medium">Paiements partiels</p>
                                <p class="text-2xl font-bold"><?php echo number_format($stats['paiements_partiels']); ?>
                                </p>
                            </div>
                            <div class="p-4 rounded-lg gradient-green text-white">
