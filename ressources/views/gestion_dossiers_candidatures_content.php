                                ...
                                <tr id="cmCandDetail_<?php echo (int) $row['id_rapport']; ?>"
                                    ...
                                    <td class="cm-data-table__td" colspan="10">
                                        <div class="cm-grid-4">
                                            ...
                                            <div>
                                                <strong>Promotion</strong><br><?php echo htmlspecialchars((string) $row['promotion'], ENT_QUOTES, 'UTF-8'); ?>
                                            </div>
                                            <div><strong>Statut
                                        ...
                                        <div class="cm-form-buttons cm-mt-md">
                                            ...
                                            <button type="button" class="cm-btn is-primary cm-pick-traitement"
