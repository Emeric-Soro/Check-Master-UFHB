...
$filteredEtudiants = array_filter($etudiants, function ($etudiant) use ($search, $promotion, $niveau, $niveauxResponsable) {
    ...
    $niveauIds = array_map(function ($niv) {
        return $niv->id_niv_etude; }, $niveauxResponsable);
        ...
        <form method="get" class="mb-6 flex flex-wrap gap-4 items-center">
            ...
            <select name="niveau"
                ...
                <?php foreach ($niveauxResponsable as $niv): ?>
                    <option value="<?= htmlspecialchars($niv->id_niv_etude) ?>" <?php if ($niveau == $niv->id_niv_etude)
                          echo 'selected'; ?>>
