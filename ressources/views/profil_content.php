...
<head>
    ...
    <style>
        ...
        select:focus {
            outline: none;
            box-shadow: 0 0 0 4px rgba(15, 76, 117, 0.12);
            border-color: var(--ufhb-blue);
        }

        .input-focus-green:focus {
            box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.12);
            border-color: var(--ufhb-green);
        }

        .alert-success {
            background-color: rgba(16, 185, 129, 0.08);
            border-left: 4px solid var(--ufhb-green);
            color: #065F46;
        }
    ...
    <div class="container px-4 py-8">
        ...
        <div class="flex border-b border-gray-200 mb-6">
            <button @click="currentTab = 'profile'"
                :class="currentTab === 'profile' ? 'tab-active' : 'text-gray-500 hover:text-gray-700'"
                class="py-2 px-4 font-medium text-sm border-b-2 -mb-px transition" data-tab="profile">
                <i class="fas fa-user mr-2"></i> Informations
            </button>
            <button @click="currentTab = 'password'"
                :class="currentTab === 'password' ? 'tab-active' : 'text-gray-500 hover:text-gray-700'"
                class="py-2 px-4 font-medium text-sm border-b-2 -mb-px transition" data-tab="password">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="nom" type="text" value="<?= $nom_user ?>" disabled
                                        class="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg input-focus-green">
                                </div>
                            </div>
                            <div class="mb-5">
        ...
        <div x-show="currentTab === 'password'" class="fade-in" x-transition>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="mt-6">
                                <button type="submit" name="update_password"
                                    class="w-full bg-green-600 text-white py-2 px-4 rounded-lg input-focus-green flex items-center justify-center">
            ...
            <div class="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul class="text-xs text-blue-700 space-y-1">
                    <li class="flex items-center"><i class="fas fa-check-circle mr-2 icon-green"></i> Minimum 8
                        caractères</li>
                    <li class="flex items-center"><i class="fas fa-check-circle mr-2 icon-green"></i> Au moins une
                        majuscule</li>
                    <li class="flex items-center"><i class="fas fa-check-circle mr-2 icon-green"></i> Au moins un
                        chiffre</li>
                    <li class="flex items-center"><i class="fas fa-check-circle mr-2 icon-green"></i> Au moins un
